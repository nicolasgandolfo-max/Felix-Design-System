...
export const SHOWCASES: Record<string, Showcase> = {
  avatar: {
    ...
    usage: {
      es: "Representa a una persona en listas de destinatarios, headers y comprobantes. Impórtalo desde @felix/ui junto con AvatarFallback para las iniciales cuando no hay foto. Controla el tamaño con size (xs a xl) y muestra un punto de estado con status (success, warning, danger o neutral).",
    ...
    render: () => (
      <>
        ...
        <Demo label="Estado">
          <Avatar size="lg" status="success">
            <AvatarFallback>MG</AvatarFallback>
          </Avatar>
          <Avatar size="lg" status="warning">
            <AvatarFallback>MG</AvatarFallback>
          </Avatar>
          <Avatar size="lg" status="danger">
            <AvatarFallback>MG</AvatarFallback>
          </Avatar>
          <Avatar size="lg" status="neutral">
            <AvatarFallback>MG</AvatarFallback>
          </Avatar>
        </Demo>
      </>
  ...
  badge: {
    ...
    usage: {
      es: "Etiqueta compacta de solo lectura para estados y metadatos: promos, estados de envío, features beta. Impórtalo desde @felix/ui y elige el estilo con variant: default, secondary, destructive, outline, ghost o dark. No es interactivo; si necesitas una acción, usa Button o IconButton.",
  ...
  button: {
    ...
    usage: {
      es: "La acción principal de cada pantalla, siempre con forma pill. Impórtalo desde @felix/ui y elige variant (primary, secondary, ghost, line o danger) y size (sm, md o lg). Acepta disabled y fullWidth para ocupar todo el ancho. Regla del sistema: un solo botón primary por pantalla.",
  ...
  checkbox: {
    ...
    usage: {
      es: "Selección de una o varias opciones independientes, como aceptar términos o aplicar filtros. Impórtalo desde @felix/ui y combínalo con Label conectando id y htmlFor. Soporta defaultChecked y disabled; si no tiene etiqueta visible, pásale un aria-label.",
  ...
  coinloader: {
    ...
    usage: {
      es: "Loader de marca con la moneda de Felix para esperas largas, como procesar una transferencia. Impórtalo desde @felix/ui, ajusta el tamaño con size (sm, md o lg) y pásale un label descriptivo para lectores de pantalla. Para cargas cortas o en línea, prefiere Spinner o Dots.",
  ...
  dots: {
    ...
    usage: {
      es: "Indicador de carga compacto para contextos en línea, como dentro de un botón o junto a un texto. Impórtalo desde @felix/ui, elige el tamaño con size (sm, md o lg) y pásale un label accesible. Para esperas largas con presencia de marca, usa CoinLoader.",
  ...
  iconbutton: {
    ...
    usage: {
      es: "Botón de solo ícono para acciones compactas como editar, eliminar o agregar. Impórtalo desde @felix/ui, pásale el ícono por la prop icon y elige variant (primary, secondary, ghost, line o danger) y size (sm, md o lg), igual que Button. El aria-label es obligatorio porque no hay texto visible.",
  ...
  input: {
    ...
    usage: {
      es: "Campo de texto de una línea con label flotante, ideal para montos, correos y datos del destinatario. Impórtalo desde @felix/ui y pásale el texto con la prop label. Usa description para un texto de ayuda debajo del campo y error para el mensaje de validación, que lo reemplaza y pinta el campo en rojo.",
      ...
      <Demo label="Estados" col>
        <div style={{ maxWidth: 340, width: "100%" }}>
          <Input
            ...
            description="Comisión $0.00 — sin sorpresas."
            defaultValue="$60.00 USD"
          />
        </div>
        <div style={{ maxWidth: 340, width: "100%" }}>
          <Input
  ...
  label: {
    ...
    usage: {
      es: "Etiqueta de formulario para acompañar Input, Checkbox, Switch o RadioGroup. Impórtala desde @felix/ui y conéctala al control con htmlFor apuntando a su id. Elige el estilo con variant: default, required, optional o disabled.",
  ...
  logo: {
    ...
    usage: {
      es: "La marca Felix para headers, sidebars y pantallas de carga. Impórtalo desde @felix/ui y elige la forma con type: logotype para el logotipo completo, symbol para el símbolo solo o symbol-circular para la versión en círculo. Controla el tamaño con la altura vía style o className, sin deformarlo.",
  ...
  progress: {
    ...
    usage: {
      es: "Barra de progreso determinada para procesos con avance medible, como completar un perfil o subir un documento. Impórtala desde @felix/ui y pásale el porcentaje con value (0 a 100), más un aria-label que describa el avance. Si no conoces el progreso, usa Spinner o CoinLoader.",
  ...
  radiogroup: {
    ...
    usage: {
      es: "Selección única entre pocas opciones visibles, como el canal de notificación. Importa RadioGroup y RadioGroupItem desde @felix/ui, define la opción inicial con defaultValue y combina cada ítem con Label conectando id y htmlFor. Si las opciones piden más jerarquía visual, usa ChoiceCard.",
    ...
    preview: () => (
      <RadioGroup defaultValue="whatsapp" aria-label="Canal">
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <RadioGroupItem value="email" id="rg-prev-email" />
            <Label htmlFor="rg-prev-email">Correo</Label>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <RadioGroupItem value="whatsapp" id="rg-prev-wa" />
            <Label htmlFor="rg-prev-wa">WhatsApp</Label>
          </div>
        </div>
      </RadioGroup>
    ),
  ...
  separator: {
    ...
    usage: {
      es: "Divisor sutil para separar bloques de contenido relacionado. Impórtalo desde @felix/ui; por defecto es horizontal y con orientation en vertical separa elementos en línea, como links de un footer. Acepta la prop label para divisores con texto, como la típica letra o entre métodos de acceso.",
  ...
  skeleton: {
    ...
    usage: {
      es: "Placeholder de carga que imita la forma del contenido mientras llega la data. Impórtalo desde @felix/ui y elige la forma con type: text, block o circle. Dale tamaño con className usando utilidades como w-full o size-12, y combina varios para replicar el layout real.",
    ...
    preview: () => (
      <div
        style={{ display: "flex", alignItems: "center", gap: 12, width: 190 }}
      >
  ...
  slider: {
    ...
    usage: {
      es: "Selección de un valor o un rango arrastrando sobre una pista, útil para montos o filtros. Impórtalo desde @felix/ui y pásale defaultValue como array: un elemento para valor único, dos para un rango. Agrégale un aria-label cuando no haya etiqueta visible.",
    ...
    render: () => (
      <Demo label="Valor y rango" col>
        ...
        <div style={{ width: 320, maxWidth: "100%" }}>
          <Slider defaultValue={[20, 80]} aria-label="Rango" />
        </div>
      </Demo>
    ),
  },
  spinner: {
    ...
    usage: {
      es: "Indicador de carga circular para esperas cortas y genéricas. Impórtalo desde @felix/ui, ajusta el tamaño con size (sm, md o lg) y pásale un label para accesibilidad. Para esperas largas con presencia de marca usa CoinLoader; para contextos en línea, Dots.",
  ...
  switch: {
    ...
    usage: {
      es: "Interruptor on/off para preferencias que aplican al instante, como activar notificaciones. Impórtalo desde @felix/ui y combínalo con Label conectando id y htmlFor. Soporta defaultChecked y disabled; usa aria-label si no hay etiqueta visible. Para opciones que se confirman con un botón, prefiere Checkbox.",
  ...
  text: {
    ...
    usage: {
      es: "Componente tipográfico que aplica la escala del sistema sin estilos a mano. Impórtalo desde @felix/ui y elige la jerarquía con variant: display-md para montos protagonistas, heading-1 para títulos de sección, body para texto corrido y caption para metadatos. Úsalo siempre en lugar de estilar etiquetas sueltas.",
    ...
    render: () => (
      <Demo label="Variantes" col>
        ...
        <Text variant="body">
          Texto de cuerpo para instrucciones y descripciones claras.
        </Text>
  ...
  textarea: {
    ...
    usage: {
      es: "Entrada de texto multilínea con label flotante para mensajes y notas, como la dedicatoria de un envío. Impórtalo desde @felix/ui, pásale el texto con label y controla la altura inicial con rows. Comparte estilo y estados con Input.",
  ...
  accordion: {
    ...
    usage: {
      es: "Organiza contenido en secciones colapsables donde solo una queda abierta a la vez, ideal para FAQs. Importa Accordion, AccordionItem, AccordionTrigger y AccordionContent desde @felix/ui. Usa type en single con collapsible para permitir cerrar todas, y dale a cada AccordionItem un value único.",
      ...
      <Demo label="Single · collapsible" col>
        ...
        >
          <AccordionItem value="a">
            ...
            <AccordionContent>
              La mayoría llega en minutos; algunos bancos pueden tardar hasta
              30.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="b">
            <AccordionTrigger>¿Hay comisión?</AccordionTrigger>
            <AccordionContent>
              No cobramos comisión. El tipo de cambio se muestra antes de
              confirmar.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
  ...
  alert: {
    ...
    usage: {
      es: "Mensaje de estado que vive en la página, sin interrumpir: envío completado, en camino o con error. Importa Alert junto con AlertTitle y AlertDescription desde @felix/ui y elige el tono con variant: success, warning o error. Para avisos efímeros usa toast; el Alert queda fijo en el layout.",
    ...
    preview: () => (
      <div style={{ width: 220 }}>
        <Alert variant="success">
          <AlertTitle>Transferencia completada</AlertTitle>
        </Alert>
      </div>
    ),
    render: () => (
      <Demo label="Variantes" col>
        <Alert variant="success">
          <AlertTitle>Transferencia completada</AlertTitle>
          <AlertDescription>María recibió $1,020.00 MXN.</AlertDescription>
        </Alert>
        <Alert variant="warning">
          <AlertTitle>Envío en camino</AlertTitle>
          <AlertDescription>
            Llega en aproximadamente 30 minutos.
          </AlertDescription>
        </Alert>
        <Alert variant="error">
          <AlertTitle>No pudimos procesar el pago</AlertTitle>
          <AlertDescription>
            Revisa tu método de pago e intenta de nuevo.
          </AlertDescription>
        </Alert>
      </Demo>
    ),
  ...
  breadcrumb: {
    ...
    usage: {
      es: "Muestra la ruta jerárquica y deja volver a niveles anteriores en flujos profundos. Importa Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage y BreadcrumbSeparator desde @felix/ui. Usa BreadcrumbLink con href para los niveles navegables y BreadcrumbPage para la página actual.",
      ...
      <Demo label="Ruta">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Envíos</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
  ...
  calendar: {
    ...
    usage: {
      es: "Calendario para elegir una fecha directamente en la página, por ejemplo al programar un envío. Impórtalo desde @felix/ui con mode en single y controla la selección con selected y onSelect. Si necesitas el calendario dentro de un campo de formulario, usa DatePicker.",
  ...
  card: {
    ...
    usage: {
      es: "Contenedor base para agrupar información relacionada, como el resumen de un envío. Importa Card con CardHeader, CardTitle, CardDescription, CardContent y CardFooter desde @felix/ui y compón solo las partes que necesites. Regla del sistema: la Card lleva borde o sombra, nunca ambos.",
  ...
  choicecard: {
    ...
    usage: {
      es: "Radio enriquecido en formato tarjeta para decisiones clave, como elegir entre efectivo o depósito bancario. Importa ChoiceCardGroup y ChoiceCard desde @felix/ui: controla el grupo con value y onValueChange, y pásale a cada tarjeta value, icon, title y description. Úsalo cuando las opciones merecen más jerarquía que un RadioGroup.",
          ...
          <div style={{ width: 300, maxWidth: "100%" }}>
            <ChoiceCardGroup value={value} onValueChange={setValue}>
              <ChoiceCard
                ...
                title="Efectivo"
                description="Recibe en efectivo"
              />
              <ChoiceCard
                value="bank"
                icon={
  ...
  collapse: {
    ...
    usage: {
      es: "Muestra u oculta un bloque de contenido secundario, como el detalle del tipo de cambio. Importa Collapse, CollapseTrigger y CollapseContent desde @felix/ui y contrólalo con open y onOpenChange. A diferencia del Accordion, es un solo bloque independiente.",
        ...
        <Demo label="Controlado" col>
          <div style={{ width: 320, maxWidth: "100%" }}>
            <Collapse open={open} onOpenChange={setOpen}>
              <CollapseTrigger>Ver detalle del envío</CollapseTrigger>
              <CollapseContent>
                Tipo de cambio 17.00 · Comisión $0.00 · Llega en ~30 min.
              </CollapseContent>
            </Collapse>
          </div>
        </Demo>
  ...
  datepicker: {
    ...
    usage: {
      es: "Campo de formulario que abre un calendario en un popover, ideal para elegir fechas sin ocupar toda la pantalla. Impórtalo desde @felix/ui y contrólalo con value y onChange; personaliza el texto vacío con placeholder. Si la fecha es el centro de la pantalla, usa Calendar directo.",
  ...
  dialog: {
    ...
    usage: {
      es: "Modal centrado para confirmaciones que piden atención total, como confirmar un envío de dinero. Importa Dialog, DialogTrigger, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter y DialogClose desde @felix/ui. Envuelve el botón que lo abre con DialogTrigger asChild y ciérralo con DialogClose. Para flujos largos en mobile, considera Drawer.",
        ...
        <Dialog>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Vas a enviar $60.00 USD a María. Comisión $0.00.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <DialogClose asChild>
  ...
  drawer: {
    ...
    usage: {
      es: "Panel que se desliza desde el borde de la pantalla, pensado mobile-first para detalles y acciones rápidas. Importa Drawer, DrawerTrigger, DrawerContent, DrawerHeader, DrawerTitle, DrawerDescription, DrawerFooter y DrawerClose desde @felix/ui, y abrilo envolviendo el disparador con DrawerTrigger asChild. Para confirmaciones puntuales en desktop, prefiere Dialog.",
    ...
    preview: () => (
      <Drawer>
        <DrawerTrigger asChild>
          <Button variant="line">Abrir drawer</Button>
        </DrawerTrigger>
      </Drawer>
    ),
    render: () => (
  ...
  dropdownmenu: {
    ...
    usage: {
      es: "Menú contextual de acciones anclado a un botón, como el menú de cuenta. Importa DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel y DropdownMenuSeparator desde @felix/ui. Envuelve el disparador con DropdownMenuTrigger asChild y agrupa acciones con DropdownMenuSeparator. Para elegir un valor de formulario, usa Select.",
    ...
    preview: () => (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="line">Opciones</Button>
        </DropdownMenuTrigger>
      </DropdownMenu>
    ),
    render: () => (
  ...
  hovercard: {
    ...
    usage: {
      es: "Tarjeta con contexto extra que aparece al pasar el mouse, como el perfil de un destinatario. Importa HoverCard, HoverCardTrigger y HoverCardContent desde @felix/ui, envolviendo el elemento con HoverCardTrigger asChild. Como en touch no hay hover, no pongas ahí información crítica.",
    ...
    preview: () => (
      <HoverCard>
        <HoverCardTrigger asChild>
          <Button variant="line">@maria</Button>
        </HoverCardTrigger>
      </HoverCard>
    ),
    render: () => (
  ...
  navigationmenu: {
    ...
    usage: {
      es: "Navegación principal horizontal con menús desplegables, típica del header del sitio. Importa NavigationMenu, NavigationMenuList, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuContent y NavigationMenuLink desde @felix/ui. Usa NavigationMenuTrigger con NavigationMenuContent para los desplegables y NavigationMenuLink con href para enlaces directos.",
    ...
    preview: () => (
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuLink href="#">Productos</NavigationMenuLink>
          </NavigationMenuItem>
          <NavigationMenuItem>
  ...
  pagination: {
    ...
    usage: {
      es: "Navegación entre páginas de resultados largos, como el historial de envíos. Importa Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext y PaginationEllipsis desde @felix/ui. Marca la página actual con isActive en PaginationLink y comprime rangos largos con PaginationEllipsis.",
  ...
  popover: {
    ...
    usage: {
      es: "Panel flotante anclado a un disparador para contenido liviano, como el detalle del tipo de cambio. Importa Popover, PopoverTrigger y PopoverContent desde @felix/ui, envolviendo el botón con PopoverTrigger asChild. A diferencia del Tooltip se abre con clic y puede contener elementos interactivos.",
    ...
    preview: () => (
      <Popover>
        <PopoverTrigger asChild>
          <Button variant="line">Abrir popover</Button>
        </PopoverTrigger>
      </Popover>
    ),
    render: () => (
  ...
  select: {
    ...
    usage: {
      es: "Para elegir una opción de una lista desplegable, como el país de destino. Importa Select, SelectTrigger, SelectValue, SelectContent y SelectItem desde @felix/ui. Pon el placeholder en SelectValue y dale a cada SelectItem un value único. Con pocas opciones, considera RadioGroup para dejarlas todas visibles.",
  ...
  sheet: {
    ...
    usage: {
      es: "Panel lateral para flujos secundarios que no ameritan cambiar de página, como el detalle de un envío. Importa Sheet, SheetTrigger, SheetContent, SheetHeader, SheetTitle, SheetDescription, SheetBody y SheetFooter desde @felix/ui. Abrilo envolviendo el disparador con SheetTrigger asChild y ciérralo con SheetClose.",
    ...
    preview: () => (
      <Sheet>
        <SheetTrigger asChild>
          <Button variant="line">Abrir panel</Button>
        </SheetTrigger>
      </Sheet>
    ),
    render: () => (
  ...
  sidebarfooter: {
    ...
    usage: {
      es: "Pie del Sidebar que muestra la cuenta del usuario activo. Impórtalo desde @felix/ui y pásale name, email y un avatar, normalmente un Avatar con AvatarFallback en tamaño sm. Va como último hijo del Sidebar, debajo de SidebarBody.",
  ...
  stepper: {
    ...
    usage: {
      es: "Muestra el avance por pasos de un flujo, como monto, destinatario y confirmación. Importa Stepper desde @felix/ui y define cada paso con Stepper.Step como hijos. Indica el paso actual con activeIndex (empieza en 0); los anteriores se marcan como completados.",
  ...
  table: {
    ...
    usage: {
      es: "Presenta datos tabulares como el historial de envíos. Importa Table, TableHeader, TableBody, TableRow, TableHead y TableCell desde @felix/ui. Usa TableHead para las celdas del encabezado y TableCell para las de datos. Para listas largas, suma Pagination.",
    ...
    preview: () => (
      <div style={{ width: 220 }}>
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>12 jun</TableCell>
              <TableCell>$60.00</TableCell>
            </TableRow>
            <TableRow>
              <TableCell>03 jun</TableCell>
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>$60.00 USD</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>03 jun</TableCell>
                <TableCell>Carlos</TableCell>
                <TableCell>$120.00 USD</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>28 may</TableCell>
                <TableCell>Ana</TableCell>
                <TableCell>$45.00 USD</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </div>
  ...
  tabs: {
    ...
    usage: {
      es: "Alterna entre vistas del mismo nivel dentro de un área, como envíos y recargas. Importa Tabs, TabsList, TabsTrigger y TabsContent desde @felix/ui. Define la pestaña inicial con defaultValue y vincula cada TabsTrigger con su TabsContent usando el mismo value.",
      ...
      <Demo label="Pestañas" col>
        <Tabs defaultValue="envios" style={{ width: "100%", maxWidth: 480 }}>
          ...
          <TabsContent value="envios">
            <Text variant="body">Tu historial de envíos aparece aquí.</Text>
          </TabsContent>
          <TabsContent value="recargas">
            <Text variant="body">Tu historial de recargas aparece aquí.</Text>
          </TabsContent>
        </Tabs>
      </Demo>
    ),
  ...
  toast: {
    ...
    usage: {
      es: "Notificación temporal que confirma una acción sin interrumpir, como un envío completado. Monta el Toaster una sola vez en la app (puedes ubicarlo con position) e importa la función toast desde @felix/ui. Dispárala con toast(titulo, opciones) pasando description, o usa toast.secondary para el estilo alternativo.",
    ...
    render: () => (
      <Demo label="Disparadores">
        <Button
          variant="primary"
          onClick={() =>
            toast("Transferencia completada", {
              description: "María recibió $1,020.00 MXN.",
            })
          }
        >
          Mostrar toast
        ...
        <Button
          variant="line"
          onClick={() =>
            toast.secondary("Envío en camino", {
              description: "Llega en ~30 min.",
            })
          }
        >
          Toast secundario
  ...
  tooltip: {
    ...
    usage: {
      es: "Etiqueta breve que aclara un control al pasar el mouse o enfocar con teclado. Importa Tooltip, TooltipProvider, TooltipTrigger y TooltipContent desde @felix/ui. Envuelve la zona con TooltipProvider y el disparador con TooltipTrigger asChild. Solo texto corto y nunca información esencial: en touch no hay hover.",
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="line">Pasa el mouse</Button>
          </TooltipTrigger>
        </Tooltip>
      </TooltipProvider>
    ),
  ...
  sidebar: {
    ...
    usage: {
      es: "Navegación lateral completa de la app: marca arriba, secciones de enlaces y cuenta abajo. Importa Sidebar, SidebarHeader, SidebarBody, SidebarSection y SidebarNavItem desde @felix/ui, y ciérralo con SidebarFooter. Cada SidebarNavItem recibe href, icon y active para marcar la ruta actual; agrupa enlaces con SidebarSection y su prop title.",
    ...
    preview: () => (
      <div style={{ transform: "scale(0.45)", transformOrigin: "top center" }}>
        <Sidebar style={{ height: 420, width: 240 }}>
          <SidebarHeader>
            <Logo type="logotype" style={{ height: 24 }} />
          </SidebarHeader>
          <SidebarBody>
            <SidebarSection title="Menú">
              <SidebarNavItem href="#sb-home" icon={<HouseIcon />} active>
                Inicio
              </SidebarNavItem>
              <SidebarNavItem href="#sb-send" icon={<PaperPlaneTiltIcon />}>
                Enviar
              </SidebarNavItem>
            </SidebarSection>
          </SidebarBody>
        ...
        <Sidebar style={{ height: 420, width: 240 }}>
          ...
          <SidebarBody>
            <SidebarSection title="Menú">
              ...
              <SidebarNavItem href="#sb-profile" icon={<UserIcon />}>
                Perfil
              </SidebarNavItem>
            </SidebarSection>
          </SidebarBody>
