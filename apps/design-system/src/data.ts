 ...
 * de `VT_SECTIONS`, así que agregar una sección al contenido la agrega aquí
...
export const VOICE_TONE_NAV: CollapsibleNavGroup[] = [
  ...
  })),
  {
    ...
    items: [
      ...
      {
        id: "prev-voice",
        path: `${PREVIOUS_VERSION_PATH}#voz`,
      ...
      {
        id: "prev-ux-writing",
        path: `${PREVIOUS_VERSION_PATH}#ux-writing`,
        icon: BookOpenIcon,
        es: "Principios de UX writing",
        en: "UX writing principles",
        pt: "Princípios de UX writing",
      },
      {
        id: "prev-case-study",
        path: `${PREVIOUS_VERSION_PATH}#caso-de-estudio`,
      ...
      {
        id: "prev-glossary",
        path: `${PREVIOUS_VERSION_PATH}#glosario`,
        icon: BookmarksIcon,
        es: "Glosario",
        en: "Glossary",
        pt: "Glossário",
      ...
      {
        id: "prev-do-dont",
        path: `${PREVIOUS_VERSION_PATH}#hace-y-evita`,
        icon: ListChecksIcon,
        es: "Haz y evita",
        en: "Do and don't",
        pt: "Faça e evite",
...
export const ILLUSTRATION_SECTIONS: {
  ...
  {
    id: "felix-illustrations",
    es: "Ilustraciones de Felix",
    en: "Felix illustrations",
    pt: "Ilustrações da Felix",
  },
  { id: "flags", es: "Banderas", en: "Flags", pt: "Bandeiras" },
  {
    id: "phosphor",
    es: "Iconografía Phosphor",
    en: "Phosphor icons",
    pt: "Iconografia Phosphor",
  },
  {
    id: "extra-icons",
    es: "Íconos extras",
...
export const TYPE_SCALE: TypeStyle[] = [
  ...
  },
  {
    ...
    lineHeight: 1.2,
    letterSpacing: "-1px",
    es: "Tu dinero está en camino",
    en: "Your money is on its way",
    pt: "Seu dinheiro está a caminho",
  },
  {
  ...
  },
  {
    ...
    lineHeight: 1.5,
    letterSpacing: "0px",
    es: "Subtítulo de sección",
    en: "Section subtitle",
    pt: "Subtítulo de seção",
  },
  {
    token: "text-body-lg",
    category: "Body",
    ...
    lineHeight: 1.3,
    letterSpacing: "0px",
    es: "Texto de cuerpo grande para introducciones.",
    en: "Large body text for introductions.",
    pt: "Texto de corpo grande para introduções.",
  },
  {
    token: "text-body",
    category: "Body",
    ...
    lineHeight: 1.2,
    letterSpacing: "0px",
    es: "Texto de cuerpo para instrucciones y descripciones claras.",
    en: "Body text for clear instructions and descriptions.",
    pt: "Texto de corpo para instruções e descrições claras.",
  },
  {
    token: "text-body-sm",
    category: "Body",
    ...
    lineHeight: 1.5,
    letterSpacing: "0px",
    es: "Texto de cuerpo pequeño para detalles secundarios.",
    en: "Small body text for secondary details.",
    pt: "Texto de corpo pequeno para detalhes secundários.",
  },
  {
    token: "text-caption",
    category: "Caption",
    ...
    es: "RECIBIDO · HACE 2 MIN",
    en: "RECEIVED · 2 MIN AGO",
    pt: "RECEBIDO · HÁ 2 MIN",
  },
  {
    token: "text-caption-sm",
    category: "Caption",
    family: "Saans",
    weight: 400,
    size: 11,
...
export const COLOR_TOKENS: {
  ...
  },
  {
    v: "--foreground",
    hex: "#082422",
    es: "Texto, superficies oscuras",
    en: "Text, dark surfaces",
    pt: "Texto, superfícies escuras",
  },
  {
    v: "--background",
    hex: "#fefcf9",
  ...
  },
  {
    v: "--muted",
    hex: "#efebe7",
    es: "Hover, fills secundarios",
    en: "Hover, secondary fills",
    pt: "Hover, preenchimentos secundários",
  },
  {
    v: "--status-success",
    hex: "#60d06f",
    es: "Completado, recibido",
    en: "Completed, received",
    pt: "Concluído, recebido",
  },
  {
    v: "--status-warning",
    hex: "#ffd200",
    es: "Pendiente, en camino",
    en: "Pending, on its way",
    pt: "Pendente, a caminho",
  },
  {
    v: "--status-error",
    hex: "#f26629",
    es: "Bloqueante, destructivo",
    en: "Blocking, destructive",
    pt: "Bloqueante, destrutivo",
  },
  {
    v: "--interactive-primary-hover",
    hex: "#1abfbe",
    es: "Hover de primario",
    en: "Primary hover",
    pt: "Hover do primário",
  },
];
...
export const RADIUS_TOKENS: {
  ...
  { t: "--radius-xs", v: "2px", es: "—", en: "—", pt: "—" },
  {
    t: "--radius-md",
    v: "8px",
    es: "Inputs, cards chicas",
    en: "Inputs, small cards",
    pt: "Inputs, cards pequenos",
  },
  {
    t: "--radius-xl",
    v: "16px",
  ...
  },
  {
    t: "--radius-2xl",
    v: "24px",
    es: "Hero cards, sheets",
    en: "Hero cards, sheets",
    pt: "Hero cards, sheets",
  },
  {
    t: "--radius-3xl",
    v: "32px",
  ...
  },
  {
    t: "--radius-full",
    v: "9999px",
    es: "Botones, badges, chips",
    en: "Buttons, badges, chips",
    pt: "Botões, badges, chips",
  },
];
...
export const SHADOW_TOKENS: {
  ...
  {
    t: "--shadow-sm",
    es: "Chips, tabs activas",
    en: "Chips, active tabs",
    pt: "Chips, abas ativas",
  },
  {
    t: "--shadow-md",
    es: "Card elevada",
  ...
  {
    t: "--shadow-lg",
    es: "Dropdowns, popovers",
    en: "Dropdowns, popovers",
    pt: "Dropdowns, popovers",
  },
  { t: "--shadow-xl", es: "Diálogos", en: "Dialogs", pt: "Diálogos" },
  {
    t: "--shadow-turquoise",
    es: "Glow de botón primario",
    en: "Primary button glow",
    pt: "Glow do botão primário",
  },
  {
    t: "--shadow-selection",
    es: "Foco turquesa (6px)",
    en: "Turquoise focus (6px)",
    pt: "Foco turquesa (6px)",
  },
];
