  ...
  return (
    <div className="plaza">
      <header className="plaza-nav">
        ...
        <nav className="plaza-nav-links" aria-label={tr("Secciones", "Sections", "Seções")}>
          ...
          <a href={FIGMA_GUIDELINES_URL} target="_blank" rel="noreferrer">
            {tr("Guías conversacionales", "Conversational guidelines", "Guias de conversa")}
          </a>
        </nav>
        <div className="plaza-lang" role="group" aria-label={tr("Idioma", "Language", "Idioma")}>
      ...
      <main className="plaza-main">
        ...
        <section className="plaza-hero">
          <div className="plaza-hero-copy">
            ...
            <a className="plaza-btn" href={FIGMA_GUIDELINES_URL} target="_blank" rel="noreferrer">
        ...
        <section className="plaza-cards">
          <article className="plaza-card">
            ...
            <Link className="plaza-btn" to="/sistema">
              {tr("Ir al Design System", "Go to Design System", "Ir para o Design System")}
            </Link>
          </article>
        ...
        {/* ── Useful links ────────────────────────────────────────────── */}
        <h2 className="plaza-links-title">{tr("Enlaces útiles", "Useful links", "Links úteis")}</h2>
        <section className="plaza-links">
          <article className="plaza-link-card">
            ...
            <a className="plaza-btn" href={FIGMA_DS_FILE_URL} target="_blank" rel="noreferrer">
              {tr("Abrir archivo de Figma", "Open Figma File", "Abrir arquivo do Figma")}
              <FigmaIcon />
            </a>
          </article>

          <article className="plaza-link-card">
            <h3>{tr("Buenas prácticas de conversación para ninjas", "Conversation best practices for ninjas", "Boas práticas de conversa para ninjas")}</h3>
            <p className="plaza-body">
              {tr(
      ...
      <footer className="plaza-footer">
        <p>{tr("Hecho con amor por el equipo de diseño de Félix", "Made with love by Félix Design Team", "Feito com amor pela equipe de design do Félix")}</p>
        <p>© 2026 Felix Technologies Inc. {tr("Todos los derechos reservados.", "All rights reserved.", "Todos os direitos reservados.")}</p>
      </footer>
    </div>
  );
}
